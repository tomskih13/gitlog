...
Функция ИмяФайлаПоРедмайна(Знач ИмяФайла, Репозиторий) Экспорт
	...
	ИмяФайла = СтрЗаменить(ИмяФайла, "/CommandModule.bsl", 	".МодульКоманды");
	...
	ИмяФайла = СтрЗаменить(ИмяФайла, "CommonCommands/", 				"$ОбщаяКоманда.");
	ИмяФайла = СтрЗаменить(ИмяФайла, "Enums/", 							"$Перечисление.");
	ИмяФайла = СтрЗаменить(ИмяФайла, "Configuration", 					"Изменения затрагивают корень конфигурации.");
	
	
	ИмяФайла = СтрЗаменить(ИмяФайла, "/Commands/", 	".Команда.");
