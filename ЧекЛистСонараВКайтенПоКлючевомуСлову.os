...
Процедура ОтправитьВКайтенСтрокиСонараПоЗаданнойКарточкеИПоисковойСтроке(ХешКоммита, urlCard) Экспорт
	...
	СписокФайловПоЗадаче 	= Задачи.СписокФайловПоЗадаче(ХешКоммита);
...
ОтправитьВКайтенСтрокиСонараПоЗаданнойКарточкеИПоисковойСтроке(ХешКоммита, urlCard);